...
export default class GameSettingsMenu extends Phaser.Scene {
    ...
    preload() {
        ...
        let data = window.localStorage.getItem('trump.audio');
    ...
    saveSettings() {
        ...
        window.localStorage.setItem('trump.audio', data);
    }
    ...
    create() {
        ...
        this.soundLabel = this.add.bitmapText(width / 2, 270, 'press_start', 'Sound Volume', 24)
            .setTint(0xffffff)
            .setOrigin(0.5, 0.1)
            .setInteractive()
    ...
    private highlightActive(active) {
        switch(active) {
            case 0:
                this.soundLabel.setTint(0xf9ed11);
                this.musicLabel.setTint(0xffffff);
                this.backLabel.setTint(0xffffff);
                break;
            case 1:
                this.soundLabel.setTint(0xffffff);
                this.musicLabel.setTint(0xf9ed11);
                this.backLabel.setTint(0xffffff);
                break;
            case 2:
                this.soundLabel.setTint(0xffffff);
                this.musicLabel.setTint(0xffffff);
                this.backLabel.setTint(0xf9ed11);
                break;           
        }
