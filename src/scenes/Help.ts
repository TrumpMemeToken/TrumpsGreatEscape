...
export default class Help extends Phaser.Scene {
    ...
    private createIntro() {
        ...
        this.line1 = this.add.bitmapText(width * 0.5, height / 2, 'press_start', 'If you allow me to connect', 32)
            .setTint(0xffffff)
            .setOrigin(0.5);
        this.line2 = this.add.bitmapText(width * 0.5, height / 2 + 48, 'press_start', 'I will check your balance for', 32)
            .setTint(0xffffff)
            .setOrigin(0.5);
        this.line3 = this.add.bitmapText(width * 0.5, height / 2 + 96, 'press_start', '$TRUMP tokens', 32)
            .setTint(0xffffff)
            .setOrigin(0.5);
        this.line4 = this.add.bitmapText(width * 0.5, height / 2 + 144, 'press_start', 'and allow you access', 32)
            .setTint(0xffffff)
            .setOrigin(0.5);
