...
export default class Level1 extends BaseScene {
    ...
    preload() {
        ...
        this.load.image('back3', 'assets/back3.webp'); //whitehouse
        this.load.image('back4', 'assets/back4.webp'); //sky
        this.load.image('back5', 'assets/back5.webp'); //skyscrapers
        this.load.image('back6', 'assets/back6.webp'); //skyscrapers front
    ...
    create() {
        ...
        AlignmentHelper.createAligned(this, totalWidth, hei, "back4", 0.375 / s, 1);
        AlignmentHelper.createAligned(this, totalWidth, hei, "back5", 0.345 / s, 1);
        AlignmentHelper.createAligned(this, totalWidth, hei, "back6", 0.365 / s, 1);
        AlignmentHelper.createAligned(this, totalWidth, hei, "back3", 0.375 / s, 1);
