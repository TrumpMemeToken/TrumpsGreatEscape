...
export default class Level2 extends BaseScene {
	...
	preload() {
        ...
        this.load.image('back4', 'assets/back4.webp'); // blue
        this.load.image('back5', 'assets/back5.webp'); // far skyline
        this.load.image('back6', 'assets/back6.webp'); // far skyline
        this.load.image('back7', 'assets/back7.webp'); // clouds            (last)
       // this.load.image('back10', 'assets/back10.webp'); //  
        this.load.image('back11', 'assets/back11.webp'); // 

        //this.load.image('back12', 'assets/back12.webp'); //  
        this.load.image('back13', 'assets/back13.webp'); // 
    ...
    create() {
        ...
        AlignmentHelper.createAligned(this, totalWidth, hei,"back4", 0.31,1);
        AlignmentHelper.createAligned(this, totalWidth, hei,"back5", 0.32,1);
        AlignmentHelper.createAligned(this, totalWidth, hei,"back6", 0.33,1);

        //AlignmentHelper.createAligned(this, totalWidth, hei,"back12", 0.345 / s,1);
        AlignmentHelper.createAligned(this, totalWidth, hei,"back13", 0.34 /s  ,1);
        AlignmentHelper.createAligned(this, totalWidth, hei,"back11",0.35 /s ,1);

        AlignmentHelper.createAligned(this, totalWidth, hei,"back7", 0.375 / s, 1);
