...
export default class Level3 extends BaseScene {
    ...
    preload() {
        ...
        this.load.image('back5', 'assets/back5.webp'); // skyline
        this.load.image('back6', 'assets/back6.webp');
        this.load.image('back7', 'assets/back7.webp'); // clouds

        this.load.image('back14', 'assets/back14.webp'); // clouds
        this.load.image('back15', 'assets/back15.webp'); // clouds
    ...
    create() {
        ...
        AlignmentHelper.createAligned(this, totalWidth, hei, "back4", 0.365 / s, 1);
        AlignmentHelper.createAligned(this, totalWidth, hei, "back5", 0.35 / s, 1);
        AlignmentHelper.createAligned(this, totalWidth, hei, "back6", 0.345 / s, 1);
        AlignmentHelper.createAligned(this, totalWidth, hei, "back7", 0.36, 1);
        AlignmentHelper.createAligned(this, totalWidth, hei, "back14", 0.375, 1);
        AlignmentHelper.createAligned(this, totalWidth, hei, "back15", 0.375, 1);
