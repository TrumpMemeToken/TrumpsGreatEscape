...
export default class Level5 extends BaseScene {
	...
	preload() {
        ...
        this.load.image( 'back16', 'assets/back16.webp' );
        this.load.image( 'back14', 'assets/back14.webp' );
        
        this.load.image( 'back1', 'assets/back1.webp') 
    ...
    create() {
        ...
        AlignmentHelper.createAligned(this, totalWidth, hei,"back1", 0.385 / s,1); //mountain
        AlignmentHelper.createAligned(this, totalWidth, hei,"back14", 0.375 / s,1); //mountain
        
        AlignmentHelper.createAligned(this, totalWidth, hei, "back16", 0.375 / s,1);
        ...
        const groundTilesNew = this.map.addTilesetImage('terrainv4', 'groundTilesv1', 64, 64, 0, 2);
        
        const propTiles = this.map.addTilesetImage('props', 'propTiles', 64, 64, 0, 2);
        this.ground1 = this.map.createLayer('ground', [ groundTiles, groundTilesNew, propTiles ]);
        this.layer1 = this.map.createLayer('layer1', [ groundTiles,groundTilesNew,propTiles ]);
