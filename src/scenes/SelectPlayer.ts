...
export default class GameSettingsMenu extends Phaser.Scene {
    ...
    constructor() {
        ...
        this.info = { rabbit: "player1", voice: "krasota", rabbitSpriteSheet: 'trump' };
    ...
    preload() {
        ...
        const data = window.localStorage.getItem('trump.player');
        ...
        globalThis.rabbitSpriteSheet = this.info.rabbitSpriteSheet || 'trump';
     }
    ...
    saveSettings() {
        ...
        window.localStorage.setItem('trump.player', data);
    }
    ...
    create() {
        ...
        this.maleRabbit = this.add.image(width / 2 - 100, 350, 'trump', '5_Turn1.webp');
        this.femaleRabbit = this.add.image(width/2 + 100, 350, 'trump', '5_Turn1.webp');
