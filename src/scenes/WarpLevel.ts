...
export default class WarpLevel extends BaseScene {
    ...
    preload() {
        ...
        this.load.image( 'back4', 'assets/back4.webp');
        this.load.image('back7', 'assets/back7.webp'); //clouds
        this.load.image('warpbg', 'assets/warpbg.webp');
    ...
    create() {
        ...
        const hei = this.map.heightInPixels;
        const s = 1;

        AlignmentHelper.createAligned(this, totalWidth, hei, 'back4', 1, s);
        AlignmentHelper.createAligned(this, totalWidth, hei, "back7", 0.375 / s, 1);
        AlignmentHelper.createAligned(this, totalWidth, hei, 'warpbg', 1,s);


        const groundTiles = this.map.addTilesetImage('ground', 'groundTilesv1', 64, 64, 0, 2);
        const groundTilesNew = this.map.addTilesetImage('terrainv4', 'groundTiles',64,64,0,2 );
        ...
        this.ground1 = this.map.createLayer('ground', [groundTiles,grasTiles,groundTilesNew]);
        this.layer1 = this.map.createLayer('layer1', [groundTiles,grasTiles,groundTilesNew]);
