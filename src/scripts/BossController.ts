...
export default class BossController {
    ...
    constructor(
        ...
        this.healthbg = this.scene.add.rectangle( this.sprite.x - (bw/2)
            , this.sprite.y + 112, bw, 24 + 2, 0, 0.6 ).setOrigin(0,0);
        this.healthbar = this.scene.add.rectangle( this.sprite.x -(bw/2) + 4
            , this.sprite.y + 112 + 4, bw - 8, 18, 0x00ff00).setOrigin(0,0);
    ...
    private spawnKey() {
        ...
        SceneFactory.basicCreate(this.scene, 'secretbox', this.sprite.body.position.x, this.sprite.body?.position.y - 64,
